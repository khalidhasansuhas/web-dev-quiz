...
const Header = () => {
    return (
        <NavLink className="p-4 top-0 dark:bg-gray-800 dark:text-gray-100 ">
            <div className=" bg-gray-800 mt-0 px-16 text-gray-100 flex justify-between h-16 mx-auto">
                <Link rel="noopener noreferrer" to='/home' aria-label="Back to homepage" className="flex items-center p-2">
                    ...
                    <h2 className='px-3'>Web Dev Quiz</h2>
                </Link>
                <ul className="items-stretch hidden space-x-3 md:flex">
                    ...
                    <li className="flex">
                        <Link rel="noopener noreferrer" to='/statistic' className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Statistic</Link>
                    </li>
                    <li className="flex">
